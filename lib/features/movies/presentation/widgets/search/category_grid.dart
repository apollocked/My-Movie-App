...
class CategoryGrid extends StatelessWidget {
  ...
  const CategoryGrid({super.key, required this.items, required this.isDark, this.bottomPadding = 0});

  static const _colors = [
    Color(0xFFE8445A), Color(0xFFFF6B35), Color(0xFF7B61FF), Color(0xFF2196F3),
    Color(0xFF4CAF50), Color(0xFFFF9800), Color(0xFF9C27B0), Color(0xFF00BCD4),
    Color(0xFFFF5722), Color(0xFFE91E63), Color(0xFF3F51B5), Color(0xFF009688),
    Color(0xFF673AB7),
  ];
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                Container(
                  width: 48, height: 48,
                  decoration: BoxDecoration(color: color.withValues(alpha: isDark ? 0.2 : 0.12), borderRadius: BorderRadius.circular(16)),
                  child: Icon(cat.icon, color: color, size: 24),
                ),
                const SizedBox(height: 10),
                Text(cat.title, textAlign: TextAlign.center, style: const TextStyle(fontWeight: FontWeight.w700, fontSize: 13)),
                const SizedBox(height: 2),
                Text(cat.subtitle, style: TextStyle(fontSize: 11, color: isDark ? AppColors.textTertiaryDark : AppColors.textTertiaryLight)),
              ],
            ),
          ),
        );
