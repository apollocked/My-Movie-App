...
class _FilterSetupPageState extends State<FilterSetupPage> {
  ...
  static const _sortOptions = [
    ('popularity.desc', 'Most Popular'), ('vote_average.desc', 'Highest Rated'),
    ('primary_release_date.desc', 'Newest First'), ('primary_release_date.asc', 'Oldest First'),
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            _sectionTitle(t, 'Select Genres'),
            const SizedBox(height: 12),
            Wrap(
              spacing: 8, runSpacing: 8,
              children: _genres.map((g) => GenreChip(
                genreId: g.$1, label: g.$2, icon: g.$3,
            ...
            const SizedBox(height: 28),
            _sectionTitle(t, 'Sort By'),
            const SizedBox(height: 8),
            FilterDropdown<String>(
              value: _sortBy, options: _sortOptions,
              ...
              child: ElevatedButton(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    const Text('Start Swiping', style: TextStyle(fontSize: 17, fontWeight: FontWeight.w700)),
                  ],
                ),
              ),
            ),
